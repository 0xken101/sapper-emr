...
```bash {"id":"01HSZPX14KKY30686HWVV2CKHR"}
npx degit "sveltejs/sapper-template#rollup" my-app
```

For a webpack-based project, instead run

```bash {"id":"01HSZPX14KKY30686HWYYBHXBM"}
...
```bash {"id":"01HSZPX14KKY30686HWZBDSM3B"}
cd my-app
npm install # or yarn
npm run dev
```
...
```bash {"id":"01HSZPX14KKY30686HX02EKYKG"}
...
```js {"id":"01HSZPX14KKY30686HX24VH0PC"}
...
```bash {"id":"01HSZPX14KKY30686HX2CTH4KS"}
...
```bash {"id":"01HSZPX14KKY30686HX41AHQGR"}
